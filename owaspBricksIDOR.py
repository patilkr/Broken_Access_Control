	...
	try:
		...
		for opt, arg in opts:
			if opt == '-h':
				...
				print ('  -s <startNumber>  		The number to start enumeration from. Default value is 0.')
				print ('  -e <endNumber>		The number to end enumeration. The default value is 5.')
				print ('_______________________________________________________________')
				print ('	Example:')
				print ('		python3 owaspBricksIDOR.py -s 0 -e 4 -u http://example.com/index.php?id=')
				print (' 		python3 owaspBricksIDOR.py -s 1 -e 3 --url http://example.com/index.php?id=   ')
				print ('_______________________________________________________________')
				sys.exit()
			elif opt == '-s':
